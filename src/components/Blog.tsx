...
const posts = [
  ...
  },
  {
    ...
    readTime: '4 min read',
    live: true,
    excerpt: "Migrating SnapCart and the YouTube Clone to TypeScript caught real bugs before production — here's what strict typing taught me about writing scalable, maintainable MERN stack code.",
    image: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?q=80&w=1000&auto=format&fit=crop',
  },
  {
    title: 'Socket.io + MongoDB: Building Real-Time Order Tracking for SnapCart',
    category: 'Tutorial',
    date: 'Dec 2025',
    readTime: '6 min read',
    live: true,
    excerpt: 'How I implemented live order status updates in SnapCart using Socket.io rooms and MongoDB — and why real-time UX made a measurable difference in the checkout experience.',
